...
public class UserController extends BaseController
{
     ...
     * 导出【请填写功能名称】列表
     */
    @PreAuthorize("@ss.hasPermi('nft:user:export')")
     ...
     * 新增【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('nft:user:add')")
     ...
     * 修改【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('nft:user:edit')")
     ...
     * 删除【请填写功能名称】
     */
    @PreAuthorize("@ss.hasPermi('nft:user:remove')")
